 ...
 */
public class StorageClsAccIDMetaService {
    ...
    public static void main(String args[]) {
        ...
        StClsAccIDMtChInit storageClsMtChInit = new StClsAccIDMtChInit(serverProperties.scratchDir,
                serverProperties.nettyProps, vertx);
        NettyTCPServer nettyTCPServer = new NettyTCPServer("/tcp/external",
                PathUtils.appendPath(serverProperties.scratchDir, "tcpserver1"), serverProperties.nettyProps, storageClsMtChInit);
