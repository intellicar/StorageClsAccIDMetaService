...
public class StClsAccIDMtConnHandler extends ChannelInboundHandlerAdapter {
    ...
    public StClsAccIDMtConnHandler(String scratchDir, Logger logger, Layer5BeaconParser l5parser, Vertx vertx) {
        super();
